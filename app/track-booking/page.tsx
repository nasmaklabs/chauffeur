...
import { SearchOutlined, CheckCircleFilled, EnvironmentOutlined, CalendarOutlined, UserOutlined, PhoneOutlined, MailOutlined, CarOutlined } from '@ant-design/icons';
...
export default function TrackBookingPage() {
    ...
    const { data: booking, isLoading, error, refetch } = trpc.booking.getByReference.useQuery(
        ...
        <Section className="min-h-screen bg-surface py-12">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-secondary mb-4">Track Your Booking</h1>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                    <Form form={form} layout="vertical" onFinish={handleSearch} size="large">
                        <Form.Item
                            ...
                            name="reference"
                            rules={[
                                { required: true, message: 'Please enter your booking reference' },
                ...
                {error && searchedReference && !isLoading && (
                    <div className="bg-white rounded-xl shadow-lg p-8 text-center">
                        ...
                        <h2 className="text-2xl font-bold text-secondary mb-4">Booking Not Found</h2>
                        <p className="text-gray-600 mb-6">
                            We couldn't find a booking with reference: <strong>{searchedReference}</strong>
                        </p>
                        <p className="text-sm text-gray-500 mb-6">
                            Please check your booking reference and try again. Your booking reference was sent to your email when you made the reservation.
                        </p>
                        <Button
                            size="large"
                            onClick={() => {
                ...
                {booking && !isLoading && (
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6 text-center">
                            ...
                            <h2 className="text-2xl font-bold text-secondary mb-2">Booking Found!</h2>
                            ...
                            <div className={`inline-block px-6 py-2 rounded-full border font-semibold ${statusColors[booking.status]}`}>
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-8">
                            ...
                            <div className="space-y-6">
                                    ...
                                    <div className="pl-6 space-y-2 text-gray-600">
                                        ...
                                        {booking.notes && (
                                            <div className="mt-3">
                                                ...
                                                <p className="mt-1 p-3 bg-gray-50 rounded border">{booking.notes}</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="pl-6 space-y-2 text-gray-600">
                                        <p><strong>Vehicle:</strong> {booking.selectedVehicle?.toUpperCase() || 'To be assigned'}</p>
                                        {booking.totalPrice && (
                                            <div className="mt-4">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                            <h4 className="font-semibold text-secondary mb-3">Important Information</h4>
                            <ul className="text-sm text-gray-600 space-y-2 list-disc list-inside">
                                <li>Please be ready 10 minutes before your scheduled pickup time</li>
                                <li>Driver details will be sent 1 hour before pickup via email and SMS</li>
