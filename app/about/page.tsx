            ...
            <Section>
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative h-[500px] bg-gray-200 rounded-2xl overflow-hidden">
                        {/* <Image src="/about-image.jpg" alt="Our Fleet" fill className="object-cover" /> */}
            ...
            <Section background="gray">
                <div className="text-center max-w-3xl mx-auto mb-12">
                    ...
                    <p className="text-gray-500">
                        We are driven by a set of core values that define who we are and how we serve our clients.
                    </p>
                </div>

                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        { title: 'Safety First', desc: 'Your safety is our top priority. Our vehicles are regularly inspected and our drivers are rigorously trained.' },
                        { title: 'Reliability', desc: 'We understand the importance of punctuality. You can count on us to be there on time, every time.' },
                        { title: 'Excellence', desc: 'We strive for perfection in every aspect of our service, from the cleanliness of our cars to the courtesy of our chauffeurs.' },
                    ].map((value, idx) => (
