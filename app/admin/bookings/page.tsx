...
export default function AdminBookingsPage() {
    const [statusFilter, setStatusFilter] = useState<'pending' | 'confirmed' | 'completed' | 'cancelled' | 'all'>('all');
            ...
            render: (_: any, record: Booking) => (
                <div className="text-sm">
                    ...
                    {record.dropoffLocation && (
                        <div className="text-gray-500 text-xs truncate max-w-xs">→ {record.dropoffLocation}</div>
                    )}
                </div>
            ),
        },
