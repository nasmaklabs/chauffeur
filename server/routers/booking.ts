...
const createBookingSchema = z.object({
  ...
  meetAndGreetCharge: z.number().optional(),
  airportCharge: z.number().optional(),
      ...
      try {
        ...
        const booking = await prisma.booking.create({
          data: {
            ...
            meetAndGreetCharge: input.meetAndGreetCharge,
            airportCharge: input.airportCharge,
        ...
        const emailData: BookingEmailData = {
          ...
          meetAndGreetCharge: booking.meetAndGreetCharge,
          airportCharge: booking.airportCharge,
