...
const PassengerDetailsStep = () => {
    ...
    const setPassengerDetails = (details: typeof passengerDetails) => bookingStore.set('passengerDetails', details);

    return (
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
            <h2 className="text-2xl font-bold mb-6 text-secondary">Passenger Details</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Form.Item label="Flight Number (Optional)">
                        <Input
                            ...
                            onChange={e => setPassengerDetails({ ...passengerDetails, flightNumber: e.target.value })}
                        />
                    </Form.Item>
                    <Form.Item label="Special Requests / Notes">
                        <Input.TextArea
                            ...
                            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setPassengerDetails({ ...passengerDetails, notes: e.target.value })}
                        />
                    </Form.Item>
                </div>
            </Form>
